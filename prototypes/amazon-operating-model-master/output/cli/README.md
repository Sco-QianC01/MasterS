...
把 亚马逊管理之道 master skill 的认知 OS 物化成 bash 工具。
...
| `decision/type.sh` | Type 决策树 (1 条规则) |
| `decision/topic-3.sh` | 一个 决策树 (1 条规则) |
| `decision/topic-4.sh` | 指标 决策树 (1 条规则) |
| `decision/topic-5.sh` | 机制 决策树 (1 条规则) |
